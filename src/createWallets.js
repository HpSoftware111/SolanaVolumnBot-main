...
const keypairsDir = path.join(dirPath, "keypairs");
const keyInfoPath = path.join(dirPath, 'keyInfo.json');
...
export async function createWallets() {
    ...
    if (action === 'c') {
        const numOfWallets = parseInt(prompt("Input number of wallets: "));
